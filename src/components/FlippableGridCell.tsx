...
const FlippableGridCell: React.FC<FlippableGridCellProps> = ({ 
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        <div 
          className={`relative w-full h-full transition-all ${transitionDuration}`}
          style={{ 
        ...
        >
          ...
          <div 
            ...
            style={{ 
              ...
              opacity: localFlipped ? 0 : 1,
              pointerEvents: localFlipped ? 'none' : 'auto',
              zIndex: localFlipped ? 0 : 2,
          ...
          <div 
            ...
            style={{ 
              ...
              opacity: localFlipped ? 1 : 0,
              pointerEvents: localFlipped ? 'auto' : 'none',
              zIndex: localFlipped ? 2 : 0,
              transition: 'opacity 300ms ease'
            }}
          >
            {renderBackContent()}
